        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModuleLeaderNote = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "role-moduleleader", null, "ModuleLeader", "MODULELEADER" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Machine learning, deep learning, NLP, and AI-driven systems.", true, "Artificial Intelligence" },
                    { 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Frontend, backend, and full-stack web technologies.", true, "Web Development" },
                    { 3, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Network security, ethical hacking, and cryptography.", true, "Cybersecurity" },
                    { 4, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Distributed systems, containerisation, and cloud platforms.", true, "Cloud Computing" },
                    { 5, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "iOS, Android, and cross-platform mobile applications.", true, "Mobile Development" },
                    { 6, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Data analysis, visualisation, and statistical modelling.", true, "Data Science" },
                    { 7, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Embedded systems, sensor networks, and IoT platforms.", true, "Internet of Things" },
                    { 8, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "SDLC, agile methodologies, and software architecture.", true, "Software Engineering" }
                });
